                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div>
                                        <button
                                            ...
                                            title="Close Menu"
                                            className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none focus:shadow-outline"
                                    ...
                                    <ul className="space-y-4">
                                        <li>
                                            <Link
                                                ...
                                                aria-label="home"
                                                title="home"
                                                className="font-medium tracking-wide text-gray-900 transition-colors duration-200 hover:text-purple-600"
                                            >
                                                Home
                                            </Link>
                                        </li>
